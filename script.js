document.addEventListener('DOMContentLoaded', () => {
    ...
    const challenges = [
        ...
        {
            title: "Door 1: Level 2 - Guess the Output",
        ...
        {
            title: "Door 1: Level 3 - Guess the Output",
        ...
        {
            title: "Door 1: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 1: Level 5 - Fill in the Blanks",
        ...
        // Door 2: Level 2 (Intermediate)
        {
            ...
            hint: "The 'pop' method removes the last element from an array."
        },
        {
            title: "Door 2: Level 2 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst obj = { a: 1, b: 2 };\nconsole.log(Object.keys(obj).length);",
            type: "mcq",
            options: ["1", "2", "3", "Error"],
            correctAnswer: "2",
            timeLimit: 90, // 1.5 minutes
            hint: "The 'Object.keys' method returns an array of the object's keys."
        },
        {
            title: "Door 2: Level 3 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst num = 5;\nconsole.log(num > 2 && num < 10);",
            type: "mcq",
            options: ["true", "false", "Error"],
            correctAnswer: "true",
            timeLimit: 90, // 1.5 minutes
            hint: "The '&&' operator returns true if both conditions are true."
        },
        {
            title: "Door 2: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 2: Level 5 - Fill in the Blanks",
            description: "Complete the code to check if a number is negative.\n\nfunction isNegative(num) {\n  return num ___ 0;\n}",
            type: "fillInTheBlank",
            correctAnswer: "<",
            timeLimit: 90, // 1.5 minutes
            hint: "The '<' operator checks if a number is less than another."
        },
        ...
        {
            title: "Door 3: Level 2 - Guess the Output",
        ...
        {
            title: "Door 3: Level 3 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst arr = [1, 2, 3];\nconsole.log(arr.reduce((a, b) => a + b));",
            type: "mcq",
            options: ["6", "[1, 2, 3]", "Error"],
            correctAnswer: "6",
            timeLimit: 120, // 2 minutes
            hint: "The 'reduce' method reduces the array to a single value."
        },
        {
            title: "Door 3: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 3: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 4: Level 2 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst arr = [1, 2, 3];\nconsole.log(arr.splice(1, 1));",
            type: "mcq",
            options: ["[2]", "[1, 3]", "Error"],
            correctAnswer: "[2]",
            timeLimit: 150, // 2.5 minutes
            hint: "The 'splice' method changes the contents of an array by removing or replacing elements."
        },
        {
            title: "Door 4: Level 3 - Guess the Output",
        ...
        {
            title: "Door 4: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 4: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 5: Level 2 - Guess the Output",
        ...
        {
            title: "Door 5: Level 3 - Guess the Output",
        ...
        {
            title: "Door 5: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 5: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 6: Level 2 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst arr = [1, 2, 3];\nconsole.log(arr[0]);",
            type: "mcq",
            options: ["1", "2", "3", "Error"],
            correctAnswer: "1",
        ...
        {
            title: "Door 6: Level 3 - Guess the Output",
        ...
        {
            title: "Door 6: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 6: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 7: Level 2 - Guess the Output",
        ...
        {
            title: "Door 7: Level 3 - Guess the Output",
        ...
        {
            title: "Door 7: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 7: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 8: Level 2 - Guess the Output",
        ...
        {
            title: "Door 8: Level 3 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst arr = [1, 2, 3];\nconsole.log(arr.slice(0, 2));",
            type: "mcq",
            options: ["[1, 2]", "[2, 3]", "Error"],
            correctAnswer: "[1, 2]",
            timeLimit: 120, // 2 minutes
            hint: "The 'slice' method returns a shallow copy of a portion of an array."
        },
        {
            title: "Door 8: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 8: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 9: Level 2 - Guess the Output",
            description: "What will be the output of the following code?\n\nconst arr = [1, 2, 3];\nconsole.log(arr.every(x => x > 0));",
            type: "mcq",
            options: ["true", "false", "Error"],
            correctAnswer: "true",
        ...
        {
            title: "Door 9: Level 3 - Guess the Output",
        ...
        {
            title: "Door 9: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 9: Level 5 - Fill in the Blanks",
        ...
        {
            title: "Door 10: Level 2 - Guess the Output",
        ...
        {
            title: "Door 10: Level 3 - Guess the Output",
        ...
        {
            title: "Door 10: Level 4 - Fill in the Blanks",
        ...
        {
            title: "Door 10: Level 5 - Fill in the Blanks",
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            door.addEventListener('click', () => {
                if (i === currentDoor) {
                    ...
                    startTimer(challenges[(i - 1) * 5].timeLimit); // Start timer with the challenge's time limit
